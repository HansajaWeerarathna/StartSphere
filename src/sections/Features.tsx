...
const FeatureTab = (
  ...
  const xPrecentage = useMotionValue(100);
  const yPrecentage = useMotionValue(50);
  ...
  return (
    <div
      ...
      className="border border-white/15 flex p-2.5 rounded-xl relative gap-2.5 items-center lg:flex-1"
    ...
    >
      ...
      <div className="h-12 w-12 border-white/15 rounded-xl inline-flex items-center justify-center">
        <DotLottiePlayer
          ref={dotLottieRef}
          src={props.icon}
          className="h-5 w-5"
